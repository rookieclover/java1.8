...
$JAVA_HOME/bin/java -Xloggc:gc.log -server -Dpid=sis2 -server -Xmx4000m -Xms1024m -Xmn360m -XX:PermSize=128m -XX:MaxPermSize=256m -XX:+UseConcMarkSweepGC cn.b2b.index.product.create.IndexProductIntimeFromDB create_intime.conf >> res.log &